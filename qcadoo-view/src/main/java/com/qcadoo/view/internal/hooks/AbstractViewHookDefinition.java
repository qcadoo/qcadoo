...
public abstract class AbstractViewHookDefinition extends AbstractHookDefinition implements ViewHookDefinition {
    ...
    protected Object performCall(final Object... args) {
        ...
        try {
            ...
            // TODO maku #QCADOO-335 - this catch statement is temporary (old view hooks didn't throw exceptions, just silently
            // logs failure). I want to minimize impact of changes, for now.
