...
QCD.components.Ribbon = function(_model, _elementName, _mainController, _translations) {
	...
	function createBigButton(path, itemModel) {
		var aElement = $("<a>").attr('accesskey', itemModel.accesskey).attr('href','#').html("<span><div"+getItemIconStyle(itemModel)+"></div><label class='ribbonLabel'>"+itemModel.label+"</label></div></div></span>");
	...
	function createBigButtonWithDropdown(path, itemModel) {
		...
		var className = "";
		if (icon) {
			style = " style=\"background-image:url(\'/qcadooView/public/img/core/icons/"+icon+"\')\"";
			className = " hasIcon";
		}
	...
	function createSmallButton(path, itemModel) {
		var itemElementButton = $("<a>").attr('accesskey', itemModel.accesskey).attr('href','#').html("<span><div"+getItemIconStyle(itemModel)+"></div><div class='btnOneLabel ribbonLabel'>"+itemModel.label+"</div></span>");
	...
	function getItemIconStyle(itemModel) {
		...
		var style = "";
		if (icon) {
			style = " class='iconElement hasIcon' style=\"background-image:url(\'/qcadooView/public/img/core/icons/"+icon+"\')\"";
		} else {
		...
		var jsObject = {
			...
			setIcon: function(icon) {
				...
				if (icon) {
					...
					iconEl.css("backgroundImage", "url(\'/qcadooView/public/img/core/icons/"+icon+"\')");
				} else {
