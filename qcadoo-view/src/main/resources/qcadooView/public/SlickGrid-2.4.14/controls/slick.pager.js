(function ($) {
  function SlickGridPager(dataView, grid, $container, options) {
    ...
    function constructPagerUI() {
      ...
      $settings
          .append("<span class='slick-pager-settings-expanded' style='display:none'>" + _options.show + " <a data=0>" + _options.all + "</a><a data='-1'>Auto</a><a data=25>25</a><a data=50>50</a><a data=100>100</a><a data=200>200</a></span>");
