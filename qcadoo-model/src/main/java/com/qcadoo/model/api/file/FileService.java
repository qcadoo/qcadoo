...
public interface FileService {
     ...
     *
     * @param entity
     * @param dateFieldName report date field name
     * @param name          translation code for language specific file name
     ...
     *
     * @param documents        documents to be compress
     * @param removeCompressed if true removes documents after compression
    ...
    File getFileFromFilenameWithRandomDirectory(final String filename, final boolean withDate);
}